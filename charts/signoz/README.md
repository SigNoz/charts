...
| `queryService.image.tag`                 | Container image tag                                                     | `0.50.0`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.50.0`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.102.2`                         |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.102.2`                         |

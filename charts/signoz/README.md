...
| `queryService.image.tag`                 | Container image tag                                                     | `0.16.2`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.16.2`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.66.5`                          |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.66.5`                          |

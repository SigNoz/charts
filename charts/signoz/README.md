...
| `queryService.image.tag`                 | Container image tag                                                     | `0.37.2`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.37.2`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.88.9`                         |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.88.9`                         |

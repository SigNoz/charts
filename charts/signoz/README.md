...
| `queryService.image.tag`                 | Container image tag                                                     | `0.13.1`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.13.1`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.66.1`                          |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.66.1`                          |

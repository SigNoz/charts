...
| `queryService.image.tag`                 | Container image tag                                                     | `0.34.1`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.34.1`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.88.1`                         |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.88.1`                         |

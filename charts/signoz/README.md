...
| `queryService.image.tag`                 | Container image tag                                                     | `0.35.1`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.35.1`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.88.3`                         |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.88.3`                         |

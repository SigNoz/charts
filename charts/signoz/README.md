...
| `queryService.image.tag`                 | Container image tag                                                     | `0.45.0`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.45.0`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.88.22`                         |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.88.22`                         |

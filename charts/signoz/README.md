...
| `queryService.image.tag`                 | Container image tag                                                     | `0.16.1`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.16.1`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.66.4`                          |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.66.4`                          |

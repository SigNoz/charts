...
| `queryService.image.tag`                 | Container image tag                                                     | `0.12.0`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.12.0`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.66.0`                          |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.66.0`                          |

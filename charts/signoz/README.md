...
| `queryService.image.tag`                 | Container image tag                                                     | `0.61.0`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.61.0`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.111.14`                         |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.111.14`                         |

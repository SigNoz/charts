...
| `frontend.replicaCount`                                     | Number of signoz nodes                                                                              | `1`                            |
...
| `frontend.serviceAccount.create`                            | Service account for signoz nodes enabled                                                            | `true`                         |
...
| `frontend.securityContext`                                  | Security context for signoz node                                                                    | `{}`                           |

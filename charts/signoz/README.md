...
| `queryService.image.tag`                 | Container image tag                                                     | `0.36.0`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.36.0`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.88.4`                         |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.88.4`                         |

...
| `queryService.image.tag`                 | Container image tag                                                     | `0.60.0`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.60.0`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.111.13`                         |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.111.13`                         |

...
| `queryService.image.tag`                 | Container image tag                                                     | `0.59.0`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.59.0`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.111.9`                         |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.111.9`                         |

...
| `queryService.image.tag`                 | Container image tag                                                     | `0.41.1`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.41.1`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.88.15`                         |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.88.15`                         |

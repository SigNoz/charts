...
| `queryService.image.tag`                 | Container image tag                                                     | `0.62.0`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.62.0`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.111.15`                         |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.111.15`                         |

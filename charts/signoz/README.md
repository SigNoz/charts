...
| `queryService.image.tag`                                    | Container image tag                                                                                        | `0.64.0`                       |
...
| `queryService.smtpVars.enabled`                             | Enable SMTP for user invitation. It will set `SMTP_ENABLED` when enabled.                                  | `false`                        |
| `queryService.smtpVars.existingSecret.fromKey`              | Name of key in secret to get value for `SMTP_FROM`. If empty, will not set the env variable.               | `""`                           | 
| `queryService.smtpVars.existingSecret.hostKey`              | Name of key in secret to get value for `SMTP_HOST`. If empty will not set the env variable.                | `""`                           | 
| `queryService.smtpVars.existingSecret.name`                 | Name fo the existing k8s secret to pick the values. Needed when one of the key for existing secret is set. | `""`                           | 
| `queryService.smtpVars.existingSecret.passwordKey`          | Name of key in secret to get value for `SMTP_PASSWORD`. If empty will not set the env variable.            | `""`                           | 
| `queryService.smtpVars.existingSecret.portKey`              | Name of key in secret to get value for `SMTP_PORT`. If empty will not set the env variable.                | `""`                           | 
| `queryService.smtpVars.existingSecret.usernameKey `         | Name of key in secret to get value for `SMTP_USERNAME`. If empty will not set the env variable.            | `""`                           | 
...
| `frontend.image.tag`                                        | Container image tag                                                                                        | `0.64.0`                       |
...
| `alertmanager.image.tag`                                    | Container image tag                                                                                        | `0.23.8`                       |
...
| `otelCollectorMetrics.image.tag`                            | Container image tag                                                                                        | `0.111.16`                     |

...
| `queryService.image.tag`                 | Container image tag                                                     | `0.37.1`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.37.1`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.88.8`                         |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.88.8`                         |

...
| `queryService.image.tag`                 | Container image tag                                                     | `0.36.2`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.36.2`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.88.6`                         |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.88.6`                         |

...
| `queryService.image.tag`                 | Container image tag                                                     | `0.11.4`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.11.4`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.63.0`                          |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.63.0`                          |

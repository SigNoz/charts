...
| `queryService.image.tag`                 | Container image tag                                                     | `0.20.0`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.20.0`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.76.1`                          |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.76.1`                          |

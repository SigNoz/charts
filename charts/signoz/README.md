...
| `queryService.image.tag`                 | Container image tag                                                     | `0.21.0`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.21.0`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.79.1`                          |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.79.1`                          |

...
| `queryService.image.tag`                 | Container image tag                                                     | `0.18.1`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.18.1`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.66.7`                          |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.66.7`                          |

...
| `queryService.image.tag`                 | Container image tag                                                     | `0.32.1`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.32.1`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.79.12`                         |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.79.12`                         |

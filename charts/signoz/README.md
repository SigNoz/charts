...
| `queryService.image.tag`                 | Container image tag                                                     | `0.33.1`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.33.1`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.79.13`                         |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.79.13`                         |

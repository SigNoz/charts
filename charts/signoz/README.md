...
| `queryService.image.tag`                 | Container image tag                                                     | `0.25.0`                          |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.25.0`                          |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.79.4`                          |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.79.4`                          |

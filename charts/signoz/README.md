...
| `queryService.image.tag`                 | Container image tag                                                     | `0.8.2`                           |
...
| `frontend.image.tag`                     | Container image tag                                                     | `0.8.2`                           |
...
| `otelCollector.image.tag`                | Container image tag                                                     | `0.45.1-0.3`                      |
...
| `otelCollectorMetrics.image.tag`         | Container image tag                                                     | `0.45.1-0.3`                      |
